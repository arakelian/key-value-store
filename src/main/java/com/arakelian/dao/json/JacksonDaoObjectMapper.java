...
public class JacksonDaoObjectMapper<T extends HasId> implements DaoObjectMapper<T> {
	private final Class<T> clazz;

	private final ObjectMapper objectMapper;

	public JacksonDaoObjectMapper(final Class<T> clazz, final ObjectMapper objectMapper) {
